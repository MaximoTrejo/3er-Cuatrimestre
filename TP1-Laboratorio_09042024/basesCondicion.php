...
<html lang="en">
    ...
    <body style="margin: 0px;">
        ...
        <main>
            <h1 style="padding-left: 20px;">Bases y Condiciones</h1>
            <div style="padding-left: 25px;">   
                <div>
                    <h3>Términos del servicio</h3>
                    <h4>INFORMACIÓN GENERAL</h4>
                    <p>Este sitio web es operado por Althi s.r.l. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Althi s.r.l. Althi s.r.l ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
